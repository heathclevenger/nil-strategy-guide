...
- Models federal income tax, self-employment tax, payroll tax, simplified state tax, LLC admin cost, S-corp admin cost, QBI assumptions, health premium planning, SEP-IRA, Solo 401(k) assumptions, annual personal spending needs, the amount that should not be locked into retirement over the next 10 years, and one-time big purchases by selected year.
...
- Recommends S-corp only when it improves after-spending/purchase wealth after modeled structure fees and does not create a cash shortfall.
- Defaults to automatic optimization for S-corp salary and retirement strategy, comparing SEP-IRA vs. Solo 401(k), applying plan-specific contribution caps, reducing contributions when spending, the 10-year retirement funding limit, or big purchases require cash, and using the better result.
